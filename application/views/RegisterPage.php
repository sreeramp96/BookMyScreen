...
<section>
    <div class="registration-form">
        <form class="form" method="post" action="<?php echo base_url('index.php/Controller/RegisterUserDetails'); ?>">
            ...
            <div class="form-group">
                <input type="username" class="form-control item" name="username" id="username" placeholder="Username">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="tel" class="form-control item" name="phonenumber" id="phonenumber" placeholder="Phone number">
            </div>
            <div class="form-group">
